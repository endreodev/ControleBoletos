...
import 'package:nlw_application/modules/insert_boleto/insert_boleto_controller.dart';
...
import 'package:nlw_application/shared/widgets/input_text/input_text_widget.dart';
        ...
        children: [
          ...
          SetLabelButtons(
            ...
            onTapSecondary: () async {
              ...
              Navigator.pushNamed(context, "/meus_boletos");
            },
          ),
        ],
      ),
